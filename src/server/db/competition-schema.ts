...
export const OrganizerSchema = z.object({
	...
	abbreviation: z
		.string()
		.optional()
		.describe("Singkatan nama (contoh: UI, ITB, Kemendikbud)"),
	type: z
		.enum([
			"University",
			"Government",
	...
	isVerified: z
		.boolean()
		.default(false)
		.describe("Status verifikasi organizer"),
...
export const CompetitionSchema = z.object({
	...
	categories: z
		.array(z.enum(CompetitionCategory))
		.nullable()
		.describe(
	...
	level: z
		.array(z.enum(["SD", "SMP", "SMA", "Mahasiswa", "Umum"]))
		.nullable()
		.describe("tingkat peserta"),

	startDate: z
		.string()
		.nullable()
		.describe("Tanggal mulai registrasi, format YYYY-MM-DD"),
	endDate: z
		.string()
		.nullable()
		.describe("Tanggal selesai registrasi, format YYYY-MM-DD"),
	...
	participationType: z
		...
		.nullable()
		.describe("Tipe partisipasi"),

	pricing: z
		.array(z.number())
		.nullable()
		.describe("Biaya pendaftaran dalam rupiah, kosong berarti gratis"),
	contact: z
		.array(z.string())
		.nullable()
		.describe("Kontak penyelenggara, nama dan nomor yang bisa dihubungi"),
