				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
					...
					<div>
						...
						<p className="text-muted-foreground mb-6">
							...
							development, from hackathons and case competitions to olympiads
							and innovation challenges. Whether you&apos;re promoting a
							university competition, corporate challenge, or any talent search,
							you&apos;ll find an engaged community ready to participate and
							compete.
						</p>
						...
						<p className="text-muted-foreground mt-4">
							Our community spans across top universities, schools, and
							companies across Indonesia. What brings them together is a shared
							passion for learning, competing, and building their portfolios
							through meaningful competitions.
						</p>
					</div>
				...
				<Card className="mb-16 bg-muted/30">
					<CardContent className="pt-8 pb-8">
						<p className="text-muted-foreground mb-6">
							...
							annual competition. The platform delivered great results, giving
							us a noticeable{" "}
