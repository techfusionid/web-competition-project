/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 1321be20657bd99bfc0f3cc99f8c89b5)
// Runtime types generated with workerd@1.20251210.0 2026-02-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_SELF_REFERENCE: Fetcher /* web-competition-project */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_POSTHOG_HOST" | "NEXT_PUBLIC_POSTHOG_KEY" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY">> {}
}
